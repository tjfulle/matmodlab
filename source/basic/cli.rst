...
Matmodlab is executed by running the ``mml`` procedure.  Several parameters can be set either on the command line or in the environment file (see :ref:`basic_config`).
...
::
  ...
  -E                    Do not use matmodlabrc configuration file
