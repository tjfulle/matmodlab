...
CONTAINS
  ...
  SUBROUTINE JACOBIAN(NPROPS, PROPS, TEMP, F, NOEL, CMNAME, INCMPFLAG, &
    ...
    DO I = 1, 6
       ...
       FM = F - DF
       SVM = STATEV
       CALL ANISOHYPEREL(NPROPS, PROPS, TEMP, FM, NOEL, CMNAME, INCMPFLAG, &
...
SUBROUTINE UMAT(STRESS,STATEV,DDSDDE,SSE,SPD,SCD,RPL,DDSDDT,DRPLDE,DRPLDT,&
  ...
  ! ---------------------------------------------------------------- UMAT --- !
  CALL ANISOHYPEREL(NPROPS, PROPS, TEMP, F1, NOEL, CMNAME, INCMPFLAG, IHYBFLAG, &
       NFIBERS, FIBER_DIR, NSTATV, STATEV, NFLDV, FIELDV, DFIELDV, STRESS)
  CALL JACOBIAN(NPROPS, PROPS, TEMP, F1, NOEL, CMNAME, INCMPFLAG, IHYBFLAG, &
