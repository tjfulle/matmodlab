import os
from utils.fortran.mml_i import DGPADM_F
...
# Abaqus materials
ABAMATS = {}
ABAMATS["umat"] = {"source_files": [ABA_IO_F90, ABA_UMAT_PYF],
                   "interface": ABA_UMAT_PY, "class": "UMat"}
ABAMATS["uanisohyper"] = {"source_files": [ABA_IO_F90, DGPADM_F, ABA_TENSALG_F90,
                          ABA_UANISOHYPER_PYF, ABA_UANISOHYPER_JAC_F90],
                          "interface": ABA_UANISOHYPER_PY, "class": "UAnisoHyper"}
ABAMATS["uhyper"] = {"source_files": [ABA_IO_F90, DGPADM_F, ABA_TENSALG_F90,
