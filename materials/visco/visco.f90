MODULE VISCO
  ...
  IMPLICIT NONE
  PRIVATE
  PUBLIC :: PROPCHECK, VISCOINI, STEPINI, VISCORELAX
...
CONTAINS
  ...
  SUBROUTINE STEPINI(DTIME, TIME, NPROP, PROPS, TEMPOLD, DTEMP, F, &
       NSTATEV, STATEV)
    ! ----------------------------------------------------------------------- !
  ...
  SUBROUTINE VISCORELAX(DTIME, TIME, TEMPOLD, DTEMP, NPROP, PROPS, F, &
    ...
    ! GET THE SHIFT FACTORS
    CALL STEPINI(DTIME, TIME, NPROP, PROPS, TEMPOLD, DTEMP, F, NSTATEV, STATEV)
