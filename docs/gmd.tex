...
list of columns.  Number is 1 based.  Ranges can be specified using Python
slice syntax.
...
% ----------------------------------------------------------------------------- %
\subsection{Attributes of Material}
\subsubsection{Model}
...
The following stub inputs demonstrate the \reqdtag{Material} input
\begin{example}
<Material model="elastic">
  <G>  54E+09 </G>
  <K> 124E+09 </K>
...
% ----------------------------------------------------------------------------- %
\subsection{Attributes of Extract}
\subsubsection{format}
...
parameters. Good for investigating model sensitivities.
%
\begin{inpusage}
...
% ----------------------------------------------------------------------------- %
\subsection{Attributes of Permutation}
...
% ----------------------------------------------------------------------------- %
\subsection{Attributes of Optimization}
\subsubsection{method}
...
\label{sec:bldf2py}
Material models written in Fortran should be built in to Python shared object
libraries with \fpy{}.  The function \texttt{utils.gmdf2py.f2yp} provides an
interface to \fpy{}.
\begin{interface}
