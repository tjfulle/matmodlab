...
Elements shown in \Red{red} are required input. Additionally, the following
elements are read from any scope in the input file
%
\begin{itemize}
  \item \tag{Include}
  \item \tag{Function}
...
\end{verbatim}
%
Define the physics of the simulation. Recognized subelements of
\reqdtag{Physics} are
%
\begin{itemize}
  \item \reqdtag{Path\sd{solid}}
  \item \reqdtag{Surface\sd{eos}}
...
\reqdtag{Path}. \sd{driver} indicates that the containing element is valid for
