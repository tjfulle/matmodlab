...
\begin{align}
  \PKTwo &= 2\left(\PDer{W}{\IBOne}\PDer{\IBOne}{\CauchyDef} +
         ...
         &= 2\left[
           \PDer{W}{\IBOne}\Jacobian^{-2/3}\left(
             \Identity - \OneThird\IOne\CauchyDef
           \right) +
           \PDer{W}{\IBTwo}\Jacobian^{-4/3}\left(
             \IOne\Identity - \CauchyDef - \TwoThird\ITwo\CauchyDef^{-1}
           \right) +
           \PDer{W}{\Jacobian}\OneHalf\Jacobian\CauchyDef^{-1}
         \right] \\
         &= 2\PDer{W}{\bar{I}_i} \PDer{\bar{I}_i}{\CauchyDef} \\
         &= \Tensor{A}{}{} \DotProd \Tensor{B}{}{}
\end{align}
%
where
%
\begin{equation}
  \Tensor{A}{}{} = \left[\PDer{W}{\IBOne} \quad
                         \PDer{W}{\IBTwo} \quad
...
\begin{equation}
  \Tensor{B}{}{} = \left[
    \Jacobian^{-2/3}\left(\Identity - \OneThird\IOne\CauchyDef\right) \quad
    \Jacobian^{-4/3}\left(
