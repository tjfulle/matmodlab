...
PLOT_COLORS = [ALICE_BLUE, DARK_OLIVE_GREEN, INDIGO, MEDIUM_PURPLE, PURPLE,
               MEDIUM_SEA_GREEN, RED, AQUA, DARK_ORCHID, AQUA_MARINE,
               DARK_RED, ROYAL_BLUE, DARK_SALMON, MEDIUM_TURQUOISE,
               SADDLE_BROWN, LAWN_GREEN, MEDIUM_VIOLET_RED, DARK_SLATE_BLUE,
               MIDNIGHT_BLUE, BLACK, DARK_SLATE_GRAY, SEA_GREEN,
               DARK_TURQUOISE, BLUE, DARK_VIOLET, SIENNA, DEEP_PINK, BROWN,
               DEEP_SKY_BLUE, NAVY, SKY_BLUE, BURLY_WOOD, CADET_BLUE,
               DODGER_BLUE, OLIVE, OLIVE_DRAB, CHOCOLATE, ORANGE,
               FOREST_GREEN, ORANGE_RED, STEEL_BLUE, FUCHSIA, ORCHID, TEAL,
               CRIMSON, LIME, PALE_TURQUOISE, TOMATO, DARK_BLUE, GOLDEN_ROD,
               PALE_VIOLET_RED, TURQUOISE, DARK_CYAN, DARK_GOLDEN_ROD, GREEN,
               MAGENTA, WHEAT, DARK_GRAY, MAROON, DARK_GREEN,
               MEDIUM_AQUA_MARINE, HOT_PINK, MEDIUM_BLUE, PLUM, DARK_MAGENTA,
               INDIAN_RED]


def random_color(plot=True, lower=False):
    if plot:
        c = PLOT_COLORS[random.randint(0, len(PLOT_COLORS)-1)]
    else:
